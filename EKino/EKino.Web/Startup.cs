...
using EKino.Repository;
using EKino.Repository.Implementation;
using EKino.Repository.Interface;
using EKino.Services;
using EKino.Services.Implementation;
...
namespace EKino.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDefaultIdentity<EKinoApplicationUser>(options => options.SignIn.RequireConfirmedAccount = true)
